      ...
      <div className="about-container">
        ...
        <section className="about-content">
          <div className="about-section">
            <h2>Наша місія</h2>
            <p>
              pinPoint створений для того, щоб допомогти людям ділитися своїми подорожами, 
          ...
          <div className="about-section">
            ...
            <p>
              ...
              pinPoint народився з нашого бажання створити простий та зручний спосіб 
              ...
              <div className="about-contact-info">
                ...
                <div className="about-contact">
                  <div className="about-contact-item">
                    ...
                    <span>support@pinpoint.com</span>
                  </div>
                  <div className="about-contact-item">
                    <span className="about-contact-icon">🌐</span>
                    <span>www.pinpoint.com</span>
                  </div>
                </div>
              </div>
